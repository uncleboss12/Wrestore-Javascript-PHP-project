/**
 * Finite Deterministic Automaton for mouse tracking code.
 * Author: Cristian Bravo-Lillo 2014(c)
 * Modified by Efrain Noa-Yarasca
 */

var fda = {
	'state': undefined,
	'data': {'s_start': {'transitions': {},'actions': {}}},
	'addTransition': function(state1, signal, state2, action) {
		if (fda.data[state1]==undefined){
			fda.data[state1] = {'transitions': {},'actions': {}};
		}
	...
	'start': function() {fda.state = 's_start';return(true);},
