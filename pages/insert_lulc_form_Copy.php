...
//            $query_insert_2 = "UPDATE REGISTER SET LULC_Q1 = 160, LULC_Q2=22, LULC_Q3=45, LULC_Q4=14, LULC_Q5=55, LULC_Q6=66 WHERE id = 182";
...
//            $result = mysqli_query($connection, $query_insert_2);
            ...
            header('Location:lulc_done.php');//E: It moves the "registry_done.php" (First way)
//            echo "name:   ".$firstname;
