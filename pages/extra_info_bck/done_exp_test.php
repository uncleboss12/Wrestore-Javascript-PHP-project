...
<body>
<?php
//E: Print the cookie created previously (where??)
echo "Welcome : ".$_COOKIE["cookie_1"]."<br>"."<br>";
session_start();
//    $pid = $_SESSION['session_name'];
echo "Hi: ".$_SESSION['user_name']."     (session started on 'login_ok.php')";
echo "<h3>Welcome to WRETORE, this is a test page</h3>";
...
<div>
    <p>This is a new page: DONE exp.php</p>
