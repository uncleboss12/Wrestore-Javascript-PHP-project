...
<div class="wrapper">
    ...
    <div class="row mainFrameRightBck" id="mainFrame">
        <div id="mainCol">
          ...
          <!-- This link was set to open the full Wrestore page. -->
            ...
            <section id="content">
                ...
                <h3> Full WRESTORE:
                  <a href="../../model_ecw/g2c.php" title="model_ecw">
                    <button style='margin-left: 30px; margin-bottom:25px;'>Here</button>
                  </a>
                </h3>
                <hr style="border-top: 2px solid #b4b4b4">

                <h3>Experiment 1
                <!-- <p style='margin-left: 100px;'> <a href='../login/login_ok_exp1.php' class='button' title='Start experiment 1'> start</a></p> -->
                <button id="exp1_setdate" style='margin-left: 30px; margin-bottom:25px;'>Start</button>

                <script type="text/javascript">
                    document.getElementById("exp1_setdate").onclick = function () {
                      // Explanation
                      //E: var d = Date.parse('15 Sep 2020 20:20:00 GMT-0000'); //E: Gives miliseconds of Greenwitch hour: Tue Sep 15 2020 13:20:00 GMT-0700 (Pacific Daylight Time). But in OR is 20:20:00
                      //E: var rr = new Date("2020-09-15T20:20:00-0000").getTime();//E: Gives smae results as above
                      //E: var n = Date.now();; //E: Gives miliseconds from now

                      //var exp1_date = new Date("2020-09-15T20:25:00-0700").getTime();//E: Gives OR hour because -0700
                      // var exp1_date = new Date("2020-09-30T08:00:00-0700").getTime(); //E: This date should be copied on L.145 'login_wait1.php'
                      var exp1_date = new Date("2020-10-13T08:00:00-0700").getTime(); //E: This date should be copied on L.145 'login_wait1.php'

                      var now = Date.now(); //E: Gives your position hour. e.g. OR hour
                      if (now < exp1_date) {
                        location.href = "../login/login_wait1.php";
                      } else {
                        location.href = "../login/login_ok_exp1.php";
                      }
                    };
                </script>
                </h3>

                <!--  For Experiment 1. Method #1 (not in use but it works perfectly) -->
                <?php
                //$user_id = $_SESSION['user_id'];
                    //// echo "User_id: ".$user_id."<br>\n"; //E: For testing

                    // if ($user_id % 2 == 1) { //E: odd id (impar)
                        //// echo "Impar!"."<br>\n"; //E: For testing
                        ////E: The session name/number is set in "g2c.php" L.171. Here, we just labeled
                        ////E: model_ecw3-->session eb-test; model_ecw4--> session neb-test
                        // echo "<p style='margin-left: 100px;'> Session 1: <a href='../../model_ecw4/g2c.php' class='button' title='model_ecw4 neb'> start</a></p>";
                        // echo "<p style='margin-left: 100px;'> Session 2: <a href='../../model_ecw3/g2c.php' class='button' title='model_ecw3 eb'> start</a></p>";
                    // } else {  //E: even id (par)
                        //// echo "Par!"."<br>\n"; //E: For testing
                        // echo "<p style='margin-left: 100px;'> Session 1: <a href='../../model_ecw3/g2c.php' class='button' title='model_ecw3 eb'> start</a></p>";
                        // echo "<p style='margin-left: 100px;'> Session 2: <a href='../../model_ecw4/g2c.php' class='button' title='model_ecw4 neb'> start</a></p>";
                    // }
                ?>

                <!--  For Experiment 1. Method #2 (not in use but it works perfectly) -->
                <!--  For Deterministic -->
                <!-- The session name/number is set in "g2c.php" L.171. Here, we just labeled -->
                <!-- <p style="margin-left: 100px;"> Session 1d: <a href="../../model_ecw4/g2c.php" title="model_ecw4 neb">Start</a></p> -->
                <!--  For No - Deterministic  -->
                <!-- <p style="margin-left: 100px;"> Session 2d: <a href="../../model_ecw3/g2c.php" title="model_ecw3 eb">Start</a></p> -->
                <!--<p> Check an experiment: <a href="../login/login_check.php">Here</a></p>-->

               <h3>Experiment 2
                 <!-- <p style="margin-left: 100px;"><a href="../login/login_ok_exp2.php" title="Start experiment 2">start</a></p> -->
                 <button id="exp2_setdate" style='margin-left: 30px; margin-bottom:25px;'>Start</button>
                 <script type="text/javascript">
                     document.getElementById("exp2_setdate").onclick = function () {
                       // var exp_date = 10;
                       // var exp2_date = Date.parse('15 Sep 2020 05:30:00 GMT'); //E: This date should be copied on L.145 'login_wait1.php'
                       //var exp2_date = new Date("2020-09-15T20:40:00-0700").getTime(); //E: This date should be copied on L.145 'login_wait1.php'
                       //var exp2_date = new Date("2020-09-30T08:00:00-0700").getTime(); //E: This date should be copied on L.145 'login_wait1.php'
                       // var exp2_date = new Date("2020-09-10T08:00:00-0700").getTime();
                       var exp2_date = new Date("2020-10-13T08:00:00-0700").getTime(); //E: This date should be copied on L.145 'login_wait1.php'

                       var now = Date.now();
                       if (now < exp2_date) {
                         location.href = "../login/login_wait2.php";
                       } else {
                         location.href = "../login/login_ok_exp2.php";
                       }
                     };
                 </script>
               </h3>
                ...
                <!--  For Exp #3  -->
                <!-- <p style="margin-left: 100px;"> Session 1: <a href="../../model_ecw7/g2c.php" title="model_ecw7 e2">Start</a></p> -->
                <!--  To survey PVQ questions   -->
                <!--  <p> Portrait Values Questionnaire (PVQ) <a href="../extra_info/insert_pvq.php">here</a> (Inactive)</p> -->
                <!--  <p style="margin-left: 100px;"> Environmental Portrait Value Questionnaire (E-PVQ): <a href="../extra_info/insert_pvq.php">Start</a></p>-->
                <!-- <p style="margin-left: 100px;"> E-PVQ Survey: <a href="../extra_info/insert_pvq.php">Start</a></p> -->
