            ...
            <section id="content">
                ...
                $user_id = $_SESSION['user_id'];
                    ...
                    if ($user_id % 2 == 1) { //E: odd id (impar)
                        ...
                        echo "<p style='margin-left: 100px;'> Session B: <a href='../../model_ecw4/g2c.php' class='button' title='model_ecw4 neb'> start</a></p>";
                    }
                ?>
                ...
                <!-- +++++ Start: Lines L.171, L.178, L.182 are activated  +++++ -->
               <!-- <h3>Experiment 2</h3> -->
                <!--  To register LULC information  -->
                <!-- <p> Set / Modify your land-use information <a href="../extra_info/insert_lulc_info.php">here</a> (Inactive)</p> -->
                <!--  To register EXPERIENCE information  -->
                ...
                <!-- +++++ End: Lines L.171, L.178, L.182 are activated  +++++ -->
            </section>
