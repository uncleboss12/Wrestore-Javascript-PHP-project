...
/* QUERY to GET Login_time (Login_time) in 'users_w2' IF extracolumns do not exist */
ALTER TABLE users_w2 ADD COLUMN (login_sec DECIMAL);
UPDATE users_w2 SET login_sec=login/1000;
ALTER TABLE users_w2 ADD COLUMN (login_time DATETIME);
UPDATE users_w2 SET login_time = from_unixtime(login_sec);
/*ALTER TABLE users_w2 DROP COLUMN login_sec;*/

/* QUERY to GET Login_time (Login_time) in 'users_w2' IF extracolumns exist */
UPDATE users_w2 SET login_sec=login/1000;
UPDATE users_w2 SET login_time = from_unixtime(login_sec);
