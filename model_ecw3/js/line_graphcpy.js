    ...
    if (option == "Watershed") {
        ...
        for (i = 0; i < numberOf_alternatives; i++) {
            ...
            data.addRow([v_label,m11,min11,max11,
                'line {fill-color:'+colors[rowlen]+';fill-opacity:'+1+'; stroke-color:'+border[rowlen]+';stroke-width:'+2+'},'+'line {stroke-color:'+'#000066'+'; stroke-width:'+1+'}',
        ...
        chart1 = new google.visualization.LineChart(document.getElementById('chart_div2'));
...
// ---------------------- else
        ...
        for (i = 0; i < numberOf_alternatives; i++) {
            ...
            data.addRow([v_label, m11, min11, max11,
                'line {stroke-color:'+colors[rowlen]+'; stroke-width:'+2+'}',
                createCustomHTMLContent(rowlen+1,'PFR',m11.toExponential(2),min11.toExponential(2),max11.toExponential(2),'PFR wrt Watershed',perm11.toExponential(2))
            ]);
            data1.addRow([v_label, m12, min12, max12,
                'line {stroke-color:'+colors[rowlen]+'; stroke-width:'+2+'}',
