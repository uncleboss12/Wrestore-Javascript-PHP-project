...
<!-- <script src="g2c.js"></script> -->
    ...
    <!-- <script type="text/javascript" src="js/bar-plot-errorbars.js"></script> -->
    <!-- <script type="text/javascript" src="js/line_graphcpy.js"></script> -->
...
// include ('read_db.php');//EE: TurnOff when 'database_option' is 1 or 2
    ...
    background-color: #357697;">
                    ...
                    <div id="line2-col2" style="float: right;">
                        <div class="topnav" style="display: -webkit-inline-box;">
                            ...
                            <div style="color: #FFFFFF">USER :
                                <span id="username_session_data" style="color: #ffffff; padding: 0px 5px">
                                    <?php echo $pid_fresh ?>
                                </span>
                                ...
                                <span id="session_pilot_test" style="color: #ffffff; padding: 0px 5px">session
                                    eb-test</span>
                            </div>
                ...
                ()" title="View instructions" style="font-size:22px">
                            ...
                            <button id="pause" class="trackable mainbuttons2 submitFeedbackJon"
                                onclick="pause_function()" title="Option to pause the website for a while"
...
the costs and benefits over the watershed landscape">STEP 1:
                            ...
                            <div>
                                <h4 class="step_title_text fontStepTitle">Learn about <font color="#7d110c">
                                        <strong>Suggested Plan SP<span class="oneMap"></span></strong>
                                    </font>
                                </h4>
                                <!--  Selection of Type-MAP (Not in use)  -->
                                <div style="display: none; position: relative; top: 30px; left: 50px; z-index: 200;">
                                    <button
                                        onclick="basemap_1.setMapTypeId(google.maps.MapTypeId.ROADMAP);">ROADMAP</button>
                                    <button
                                        onclick="basemap_1.setMapTypeId(google.maps.MapTypeId.SATELLITE);">SATELLITE</button>
                                </div>
                                <!--  Full-screen buttom for main map  -->
                                <input id="fullscreen" class="trackable" title="Click here to display a fullscreen map"
                                    type="button" value="Full-screen" style="position: relative; top: 55px;
     left: 20px; z-index: 200; width: 90px; height: 26px;/*background-color: #fcd4b5;*/ cursor: pointer" />
        ...
        meters per second (cms)" href="#tabs-PF">PFR</a>
                                        </li>
                                        <li style="display: none"><a id="step1_SR_tab" class="trackable"
                                                title="Sediment Reduction in tons" href="#tabs-SR">SR</a></li>
                                        <!--                                <li><a id="step1_SR_tab" class="trackable" title="Sediment Reduction in tons" href="#tabs-SR">SR</a></li>-->
                                        <li style="display: none"><a id="step1_NR_tab" class="trackable"
                                                title="Nitrate Reduction in kilograms (kg)" href="#tabs-NR">NR</a></li>
                                        <!--                                <li><a id="step1_NR_tab" class="trackable" title="Nitrate Reduction in kilograms (kg)" href="#tabs-NR">NR</a></li>-->
                                        <li style="display: none; width: 40px;"><a id="step1_P_tab" class="trackable"
                                                title="Profit (Revenue-Cost)
        in US Dollars" style="margin: 0px 0px 0px 4px;" href="#tabs-RV">P</a></li>
                                    </ul>
                                    <div class="tab_container2">
                                        <!--    ------------ (1a) tab-Info of HeatMap  ------------   -->
                                        <div id="info_heatmap" class='tab_content2'
                                            ...
                                            <p>Click on the PFR tab to view how the performance (i.e., benefits and
                                                costs) of this
                                                suggested plan spatially varies over the watershed. </p>
                                            <p>Acronyms stand for:</p>
                                            <ul>
                                                <li>
                                                    <p><b>PFR </b>is Peak Flow Reduction in cubic meters per second
                                                        (cms)
                                                        . This represents the benefit of reduced flooding in the
                                                        landscape</p>
                                                </li>
                                                <li style="display: none">
                                                    <p><b>SR </b>is Sediment Reduction in tons. This represents the
                                                        benefit of
                                                        reduced erosion in the landscape.
                                                    </p>
                                                </li>
                                                <li style="display: none">
                                                    <p><b>NR </b>is Nitrate Reduction in Kilograms (kg). This represents
                                                        the benefit of reduced fertilizer loss in the landscape.</p>
                                                </li>
                                                <li style="display: none">
                                                    <p><b>P </b>is Profit (Revenue-Expenses) in US Dollars. This
                                                        represents the
                                                        monetary benefits minus costs accrued from implementing proposed
                                                        conservation
                                                        decisions on the landscape.</p>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--    ------------ (2a) tabs-PFR heatmap ------------   -->
                                        <div id="tabs-PF" class="map1">
                                            <div class="tab-header2">
                                                <h4 class="fontStepTitle">Suggested Plan P<span class="oneMap"></span>
                                                </h4>
                                                <input id="fullscreen_heatmap1" class="trackable" type="button"
                                                    style="display: none" title="Click here to display a fullscreen map"
                                                    value="fullscreen PFR" />
                                            </div>
...
meters per second (cms)" href="#tabs-PF">PFR</a></li>
                                        <li><a id="step1_SR_tab" class="trackable" title="Sediment Reduction in tons"
                                                href="#tabs-SR">SR</a></li>
                                        <li><a id="step1_NR_tab" class="trackable"
                                                title="Nitrate Reduction in kilograms (kg)" href="#tabs-NR">NR</a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 debug" style="height: 100%; padding-left: 8px;">
                    ...
                    <div class="panel_2" name='step2_goals' style="/*width: 23.3%; right: 5px; top: 0px;*/">
                        ...
                        <div class="step_line" style="height: 26px; margin: 0px 0px 3px 0px;">
                            <div id='step2' class="step_box" name="step2" style="width: 75px;" title="Learn about how costs and benefits of this suggested plan
compare to those of other recommended suggested-plans
(on previous or following pages of this session)">
                                STEP 2:
                            </div>
                            <div>
                                <h4 class="step_title_text fontStepTitle">Evaluate <font color="#7d110c">
                                        <strong>Suggested
                                            Plan SP<span class="oneMap"></span></strong>
                                    </font>
                                </h4>
                            </div>
                        </div>
...
meters per second (cms)" href="#PFR_barplot">PFR</a></li>
                                    <li style="display: block"><a id="step2-SR" class="trackable"
                                            title="Sediment Reduction in tons" href="#SR_barplot"> SR</a></li>
                                    <li style="display: block"><a id="step2-NR" class="trackable"
                                            title="Nitrate Reduction in kilograms (kg)" href="#NR_barplot"> NR</a></li>
                                    <li style="display: block; width: 40px;"><a id="step2-P" class="trackable" title="Profit (Revenue-Cost)
                            ...
                            4px;" href="#CR_barplot">P</a></li>
                                ...
                                <div class="tab_container1" style="height: calc(100% - 37px);">
                                    ...
                                    <div id="start_barplot" style="height: 99%; overflow: auto;">
                                        ...
                                        <h4 style="font-size: 20px">Instructions </h4>
                                        <p>Click on the PFR tab to view bar plots that assess the performance (i.e.,
                                            benefits) of
                                            this suggested plan in comparison to others.</p>
                                        <p>Also, note the following about the bar plots:</p>
                                        <ol>
                                            <li>The yellow colored bar corresponds to the suggested plan you see on this
                                                page.</li>
                                            <li>The other bars represent the rest of the suggested plans that you will
                                                be evaluating and
                                            ...
                                            <li>The length of the bar corresponds to an average value of the benefit.
                                                When thin lines are present with the bars, they indicate the range
                                                (i.e.,
                                            ...
                                            <li>
                                                ...
                                                <ul style="list-style-type:disc">
                                                    ...
                                                    <li style="display: none">
                                                        <p><b>NR </b>is Nitrate Reduction in Kilograms (kg). This
                                                            represents
                                                            the benefit of reduced fertilizer loss in the landscape.</p>
                                                    </li>
                                                    <li style="display: none">
                                                        <p><b>P </b>is Profit (Revenue-Cost) in US Dollars. This
                                                            represents the
                                                            expenses and revenue accrued from implementing proposed
                                                            conservation
                                                            decisions on the landscape.</p>
                                                    </li>
                                                </ul>
                ...
                <div class="debug" style="width: 74%">
                    <div class="rating_backnext debug">
                        <div class="vote_section"
                            style="position: relative; /*left: 345px; top: -515px;*/ z-index: 100;">
                            <div class="step_line">
                                <div class="step_box" name="step3" title="Let's Vote!" style="height: 26px;">STEP 3:
                                </div>
                                    ...
                                    <div class="map1" style="height:25px; display: inline-flex; margin: 5px;">
                                        <div>
                                            <h4 class="step_title_text fontStepTitle">Rate <font color="#7d110c">
                                                    <strong>Suggested Plan P<span class="oneMap"></span></strong>
                                                </font>
                                        ...
                                        <div class="innerMapLines" style="min-width: 120px;">
                                            <div class="rating">
                                                ...
                                                <input id='performance_rate_0' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="0" checked /><span
                                                    id="hide"></span>
                                                <input id='performance_rate_1' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="1" /><span></span>
                                                <input id='performance_rate_2' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="2" /><span></span>
                                                <input id='performance_rate_3' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="3" /><span></span>
                                                <input id='performance_rate_4' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="4" /><span></span>
                                                <input id='performance_rate_5' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="5" /><span></span>
                                                <input id='performance_rate_6' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="6" /><span></span>
                                                <input id='performance_rate_7' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="7" /><span></span>

                                                <input name="rating1" type="text" class="padInput" id="rating1"
                                                    size="2" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="innerMapLines1">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="22%"><input name="confidence1" type="text"
                                                            id="confidence1" size="3" readonly="readonly" /></td>
                                                    <td width="78%">
                                                        <div id="slider"></div>
                                                    </td>
                                                </tr>
                                ...
                                <div style="display:none;">
                                    <div class="map1" style="display: inline-flex; margin: 5px;">
                                        ...
                                        <div class="innerMapLines" style="min-width: 120px;">
                                            <div class="rating">
                                                <input id='step3_star0' class="trackable" name="rating2" type="radio"
                                                    value="0" checked /><span id="hide"></span>
                                                <input id='step3_star1' class="trackable" name="rating2" type="radio"
                                                    value="1" /><span></span>
                                                <input id='step3_star2' class="trackable" name="rating2" type="radio"
                                                    value="2" /><span></span>
                                                <input id='step3_star3' class="trackable" name="rating2" type="radio"
                                                    value="3" /><span></span>
                                                <input id='step3_star4' class="trackable" name="rating2" type="radio"
                                                    value="4" /><span></span>
                                                <input id='step3_star5' class="trackable" name="rating2" type="radio"
                                                    value="5" /><span></span>
                                                <input id='step3_star6' class="trackable" name="rating2" type="radio"
                                                    value="6" /><span></span>
                                                <input id='step3_star7' class="trackable" name="rating2" type="radio"
                                                    value="7" /><span></span>
                                                <input name="rating2" type="text" class="padInput" id="rating2"
                                                    size="2" />
                                            </div>
                                        </div>
            ...
            <div id="message_box">
                ...
                font-weight:normal; color:#7d110c;font-size:20px;/*font-weight:300;*/text-transform:uppercase;">
                    ...
                    <p>In WRESTORE, every <b>suggested plan</b> consists of multiple conservation
                        ...
                        recommended conservation practice (e.g. wetlands), location where the practice is implemented,
                        and other
                    ...
                    <p>You are advised to first learn about decisions recommended by a suggested conservation plan (i.e.
                        ...
                        overall performance (i.e. <b>Step 3</b>).
                    </p>
                    <div style="line-height:30%;"><br></div>
