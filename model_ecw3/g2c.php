...
meters per second (cms)" href="#PFR_barplot" >PFR</a></li>
                            <li style="display: block"><a id="step2-SR" class="trackable" title="Sediment Reduction in tons"
                                   href="#SR_barplot" > SR</a></li>
                            <li style="display: block"><a id="step2-NR" class="trackable" title="Nitrate Reduction in kilograms (kg)"
