...
meters per second (cms)" href="#PFR_barplot">PFR</a></li>
                                    <li style="display: none"><a id="step2-SR" class="trackable"
                                            title="Sediment Reduction in tons" href="#SR_barplot"> SR</a></li>
                                    <li style="display: none"><a id="step2-NR" class="trackable"
...
in US Dollars" style="margin: 0px 0px 0px
                            4px;" href="#CR_barplot">P</a></li>
                                ...
                                <div class="tab_container1" style="height: calc(100% - 37px);">
                                    ...
                                    <!--    ------------ (2b)  tabs-PFR Barplot ------------   -->
                                    <div id="PFR_barplot"
                                        style="height: 100%; overflow-x: hidden; overflow-y: overlay;">
                            ...
                            11px; color: #7d110c;">
                                        ...
                                        <div
                                            style="position: absolute; transform: rotate(270deg); top: 200px; left:-55px;">
                                            Suggested Plans - SP
                                        </div>
                                    </div>
                                    ...
                                    <div class="map1" style="height:25px; display: inline-flex; margin: 5px;">
                                        ...
                                        <div class="innerMapLines" style="min-width: 120px;">
                                            <div class="rating">
                                                ...
                                                <input id='perform_rate_0_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="0" checked /><span
                                                    id="hide"></span>
                                                <input id='perform_rate_1_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="1" /><span></span>
                                                <input id='perform_rate_2_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="2" /><span></span>
                                                <input id='perform_rate_3_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="3" /><span></span>
                                                <input id='perform_rate_4_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="4" /><span></span>
                                                <input id='perform_rate_5_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="5" /><span></span>
                                                <input id='perform_rate_6_stars' class="trackable check_last_SP"
                                                    name="rating1" type="radio" value="6" /><span></span>
                                                <input id='perform_rate_7_stars' class="trackable check_last_SP"
